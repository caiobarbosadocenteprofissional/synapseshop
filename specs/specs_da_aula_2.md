...
- [X] É possível levantar o ambiente completo utilizando **exclusivamente** o comando `docker-compose up` no terminal[cite: 1].
- [X] O código gerado foi commitado e "pushado" (pushed) para o repositório central no GitHub.